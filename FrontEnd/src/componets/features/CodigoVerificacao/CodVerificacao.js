      ...
      <div style={styles.loginCard}>
        ...
        <form style={styles.loginForm}>
          <div style={styles.formGroup}>
            <label htmlFor="codigo" style={styles.label}>Código de verificação</label>
            <input
              type="text"
              id="codigo"
          ...
          <div style={styles.buttonContainer}>
            <Link to="/RedefinirSenha" style={styles.loginBtn}>Verificar</Link>
          </div>
        </form>
      </div>
    </div>
...
// Estilos IDÊNTICOS ao EsqueceuSenhaLink
const styles = {
  loginContainer: {
    width: '100%'
  },

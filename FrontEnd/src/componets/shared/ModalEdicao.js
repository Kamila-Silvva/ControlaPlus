...
const ControleMensal = () => {
  ...
  }, [mesParam, navigate, nomeMesFormatado]);
    ...
    (resumosAtuais, todosRegistros, mesAtualNome) => {
      ...
      if (indiceMesAtual > 0) {
        ...
        if (
          ...
          novasMensagens.push({
            id: "parabensCompulsivo",
            tipo: "parabensCompulsivo",
            texto:
              "🎉 Parabéns! Você reduziu significativamente seus gastos impulsivos em relação ao mês anterior! Continue assim!",
          });
        }
      }
  ...
  return (
    <div style={styles.container}>
      ...
      />
      <TabelaItens
        titulo="Gastos Reais (Não Compulsivos)"
      ...
      <TabelaItens
        ...
        colunas={["Descrição", "Data", "Valor", "Emoção", "Ações"]}
        isRealizado={true}
        onEdit={(item) => abrirModal("editar_realizado", item)}
        onRemove={handleRemoverLancamento}
        loading={loading}
    ...
    <div style={styles.modalOverlay} onClick={onClose}>
      <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={styles.modalButtonContainer}>
          ...
          <button style={styles.buttonSave} onClick={handleSalvar}>
            Salvar
          </button>
        </div>
      </div>
...
// --- ESTILOS CSS-IN-JS ---
const styles = {
  // Estilos Gerais da Página ControleMensal
  container: {
    padding: "30px 20px",
    maxWidth: "1200px",
    margin: "0 auto",
  ...
  // Modal (Estilos inspirados no ModalEdicao e Projecao.module.css)
  modalOverlay: {
    position: "fixed",
    top: 0,
    left: 0,
  ...
  formGroup: { marginBottom: "1rem" }, // Equivalente a .campo-formulario
  modalLabel: {
    display: "block",
    fontSize: "0.875rem",
    fontWeight: 300,
  ...
  modalSelect: {
    ...
    fontFamily: "'Public Sans', sans-serif",
    backgroundColor: "var(--branco)",
  }, // Equivalente a .campo-select
  modalCheckboxContainer: {
    display: "flex",
    alignItems: "center",
    gap: "0.5rem",
    margin: "1rem 0",
  }, // Equivalente a .campo-formulario-checkbox
  modalButtonContainer: {
    display: "flex",
    justifyContent: "flex-end",
    gap: "1rem",
    marginTop: "2rem",
  }, // Equivalente a .botoes-modal
  buttonCancel: {
...
if (!document.getElementById("app-color-vars")) {
  ...
  styleSheet.innerText = `:root { --roxo-principal: #9747FF; --roxo-escuro: #6C63FF; --roxo-claro: #a855f7; --cinza-escuro: #2F2E41; --cinza-medio: #0D0C0B; --cinza-claro: #F5F5F5; --branco: #FFFFFF; --sombra: 0 4px 6px rgba(0, 0, 0, 0.05); --cor-sucesso: #28a745; --cor-perigo: #dc3545; }`;
